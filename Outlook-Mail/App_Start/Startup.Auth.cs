...
using Owin;
using Outlook_Mail.Models;

using Outlook_Mail.TokenStorage;
...
namespace Outlook_Mail
{
    public partial class Startup
    {
        ...
        private async Task OnAuthorizationCodeReceived(AuthorizationCodeReceivedNotification notification)
        {
            ...
            ConfidentialClientApplication cca = new ConfidentialClientApplication(appId, redirectUri, new ClientCredential(appPassword), tokenCache.GetMsalCacheInstance(), null);
